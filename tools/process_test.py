...
current_dir= '/media/hkuit164/WD20EJRX/yolov3-channel-and-layer-pruning/data/ensemble/gray/JPEGImages'
# print(current_dir)
# percentage_test = 10
percentage_test = 10
...
for pathAndFilename in glob.iglob(os.path.join(current_dir, "*.jpg")):
    ...
    #     counter = 1
    file_test.write('./data/ensemble/gray/JPEGImages' + "/" + title + ".jpg" + "\n")
    # else:
