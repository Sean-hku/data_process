...
# percentage_test = 10
percentage_test = 10
file_train = open(current_dir[:-10]+'fish_train.txt', 'w')
file_test = open(current_dir[:-10]+'fish_val.txt', 'w')
...
for pathAndFilename in glob.iglob(os.path.join(current_dir, "*.jpg")):
    ...
    if counter == index_test:
        counter = 1
        file_test.write('./data/fish/JPEGImages' + "/" + title + ".jpg" + "\n")
    else:
        file_train.write('./data/fish/JPEGImages' + "/" + title + ".jpg" + "\n")
        counter = counter + 1
